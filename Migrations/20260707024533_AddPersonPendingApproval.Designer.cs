...
namespace Turnos.Migrations
{
    ...
    [Migration("20260707024533_AddPersonPendingApproval")]
    partial class AddPersonPendingApproval
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Turnos.Models.CompanyDocument", b =>
                {
            ...
            modelBuilder.Entity("Turnos.Models.EventComment", b =>
                {
                    b.Property<int>("EventCommentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("EventCommentId"));
            ...
            modelBuilder.Entity("Turnos.Models.MessageLog", b =>
                {
                    ...
                    b.Property<int?>("WhatsAppGroupId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Turnos.Models.CompanyDocument", b =>
                {
                    b.HasOne("Turnos.Models.Company", "Company")
                        .WithOne()
                        .HasForeignKey("Turnos.Models.CompanyDocument", "CompanyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Turnos.Models.MessageLog", b =>
                {
                    ...
                    b.HasOne("Turnos.Models.WhatsAppGroup", "WhatsAppGroup")
                        .WithMany("MessageLogs")
