        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequiredSupervisors = table.Column<int>(type: "int", nullable: false),
                    RequiredUshers = table.Column<int>(type: "int", nullable: false),
                    RequiredOther = table.Column<int>(type: "int", nullable: false),
                    RequiredOtherLabel = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Availabilities_Persons_PersonId",
                        column: x => x.PersonId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PersonRoles_StaffRoles_RoleId",
                        column: x => x.RoleId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MessageLogs_Events_EventId",
                        column: x => x.EventId,
                        principalTable: "Events",
                        principalColumn: "EventId",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AttendanceBreakId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AttendanceId = table.Column<int>(type: "int", nullable: false),
                    BreakStartDateTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    BreakEndDateTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Notes = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AttendanceBreaks", x => x.AttendanceBreakId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Assignments_PersonId_StartDateTime_EndDateTime",
                table: "Assignments",
                columns: new[] { "PersonId", "StartDateTime", "EndDateTime" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attendances_EventId_CheckInDateTime",
                table: "Attendances",
                columns: new[] { "EventId", "CheckInDateTime" });

            migrationBuilder.CreateIndex(
                name: "IX_Attendances_PersonId_CheckInDateTime",
                table: "Attendances",
                columns: new[] { "PersonId", "CheckInDateTime" });
